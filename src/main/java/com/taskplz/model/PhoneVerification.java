...
public class PhoneVerification extends PhoneVerificationVO implements IModelCRUD {

	private SqlSession sqlSession;

	protected static final String mapperNS = "com.taskplz.mapper.PhoneVerification.";

	@SuppressWarnings("unused")
	private PhoneVerification() {
	};

	protected PhoneVerification(SqlSession sqlSession) {
		this.sqlSession = sqlSession;
	};

	protected PhoneVerification(SqlSession sqlSession, PhoneVerificationVO vo) {
		this.sqlSession = sqlSession;
		this.copy(vo);
	};
	...
	public void load(String verificationID) throws ModelException {
		try {
			PhoneVerificationVO vo = sqlSession.selectOne(mapperNS + "select", verificationID);
			if (vo == null)
