...
public class DepositLog extends ExampleVO implements IModelCRUD {
	...
	protected DepositLog(SqlSession sqlSession) {
		this.sqlSession = sqlSession;
	};

	protected DepositLog(SqlSession sqlSession, ExampleVO vo) {
		this.sqlSession = sqlSession;
		this.copy(vo);
	};
