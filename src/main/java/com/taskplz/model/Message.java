...
public class Message extends ExampleVO implements IModelCRUD {
	...
	protected Message(SqlSession sqlSession) {
		this.sqlSession = sqlSession;
	};

	protected Message(SqlSession sqlSession, ExampleVO vo) {
		this.sqlSession = sqlSession;
		this.copy(vo);
	};
