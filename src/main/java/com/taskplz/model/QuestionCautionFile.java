...
public class QuestionCautionFile extends FileVO implements IModelCRUD {

	private SqlSession sqlSession;

	protected static final String mapperNS = "com.taskplz.mapper.QuestionCautionFile.";

	@SuppressWarnings("unused")
	private QuestionCautionFile() {
	};

	protected QuestionCautionFile(SqlSession sqlSession) {
		this.sqlSession = sqlSession;
	};

	protected QuestionCautionFile(SqlSession sqlSession, FileVO FileVO) {
		this.sqlSession = sqlSession;
		this.copy(FileVO);
	};
