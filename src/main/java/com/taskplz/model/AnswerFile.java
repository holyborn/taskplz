...
public class AnswerFile extends ExampleVO implements IModelCRUD {
	...
	protected AnswerFile(SqlSession sqlSession) {
		this.sqlSession = sqlSession;
	};

	protected AnswerFile(SqlSession sqlSession, ExampleVO vo) {
		this.sqlSession = sqlSession;
		this.copy(vo);
	};
