...
public class Example extends ExampleVO implements IModelCRUD {
	...
	protected Example(SqlSession sqlSession) {
		this.sqlSession = sqlSession;
	};

	protected Example(SqlSession sqlSession, ExampleVO vo) {
		this.sqlSession = sqlSession;
		this.copy(vo);
	};
