...
public class QuestionExpectedFormFile extends FileVO implements IModelCRUD {

	private SqlSession sqlSession;

	protected static final String mapperNS = "com.taskplz.mapper.QuestionExpectedFormFile.";

	@SuppressWarnings("unused")
	private QuestionExpectedFormFile() {
	};

	protected QuestionExpectedFormFile(SqlSession sqlSession) {
		this.sqlSession = sqlSession;
	};

	protected QuestionExpectedFormFile(SqlSession sqlSession, FileVO FileVO) {
		this.sqlSession = sqlSession;
		this.copy(FileVO);
	};
