...
public class Application extends ExampleVO implements IModelCRUD {
	...
	protected Application(SqlSession sqlSession) {
		this.sqlSession = sqlSession;
	};

	protected Application(SqlSession sqlSession, ExampleVO vo) {
		this.sqlSession = sqlSession;
		this.copy(vo);
	};
