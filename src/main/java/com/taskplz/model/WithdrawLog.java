...
public class WithdrawLog extends ExampleVO implements IModelCRUD {
	...
	protected WithdrawLog(SqlSession sqlSession) {
		this.sqlSession = sqlSession;
	};

	protected WithdrawLog(SqlSession sqlSession, ExampleVO vo) {
		this.sqlSession = sqlSession;
		this.copy(vo);
	};
