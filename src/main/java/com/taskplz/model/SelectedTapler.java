...
public class SelectedTapler extends ExampleVO implements IModelCRUD {
	...
	private SelectedTapler() {
	};

	protected SelectedTapler(SqlSession sqlSession) {
		this.sqlSession = sqlSession;
	};

	protected SelectedTapler(SqlSession sqlSession, ExampleVO vo) {
		this.sqlSession = sqlSession;
		this.copy(vo);
	};
